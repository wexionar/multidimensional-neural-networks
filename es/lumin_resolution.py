...
class LuminResolution:
    ...
    def resolve(self, X_input):
        ...
        # We add a small tolerance (epsilon) for floating point stability
        ...
        if len(candidate_indices) == 0:
            return None # The point is in the "Void" (Territorio desconocido)
        
        # 4. Compute Linear Law (using the first matching sector)
...
if __name__ == "__main__":
    ...
    # Simulamos carga de un sector maestro (Ley: Y = X1 + X2 + 10)
    # Formato: [MinX1, MinX2, MaxX1, MaxX2, W1, W2, Bias]
    mock_data = {
        'X0_min': [0], 'X1_min': [0],
        'X0_max': [10], 'X1_max': [10],
        'W0': [1], 'W1': [1],
